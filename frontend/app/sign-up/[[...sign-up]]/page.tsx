      ...
      >
        ...
        <div className="flex items-center justify-between border-b-2 border-black pb-4 mb-6 text-indigo-400">
          <div className="flex items-center gap-2">
            ...
            <span className="font-silk text-[8px] uppercase tracking-[0.2em] font-bold">REGISTRATION_PORT // PORT_80</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 bg-red-500 rounded-full animate-ping" />
            <span className="font-silk text-[6px] text-red-500 uppercase tracking-widest font-bold">REG_ACTIVE</span>
          </div>
        </div>
