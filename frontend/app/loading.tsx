...
export default function Loading() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gray-950 flex flex-col items-center justify-center p-6 select-none pixel-grid">
      {/* Scanline sweep and phosphor glow overlay */}
      <div className="absolute inset-0 pointer-events-none bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.3)_50%)] bg-[length:100%_4px] opacity-30" />
      <div className="scan-sweep opacity-20" />

      {/* Cyber deck screen box */}
      <div className="w-full max-w-md border-4 border-black bg-black p-6 relative shadow-[8px_8px_0_0_#000] glow-indigo flex flex-col gap-6">
