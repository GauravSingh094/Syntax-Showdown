...
class OpenRouterProvider(BaseLLMProvider):
    def __init__(self):
        super().__init__(
            name="openrouter",
            debate_model="meta-llama/llama-3.3-70b-instruct",
    ...
    def _calculate_cost(self, model: str, input_tokens: int, output_tokens: int) -> float:
        ...
        if "deepseek-r1" in model:
            # DeepSeek R1 rate: $0.55/M input, $2.19/M output
            input_rate = 0.55 / 1_000_000
            output_rate = 2.19 / 1_000_000
        else:
            # Llama 3.3 70B rate: $0.12/M input, $0.30/M output
            input_rate = 0.12 / 1_000_000
    ...
    async def generate(self, prompt: str, role: str, format_json: bool = False, model: Optional[str] = None) -> LLMResponse:
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/GauravSingh094/Syntax-Showdown",
            "X-Title": "Syntax Showdown"
        }
